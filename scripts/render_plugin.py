...
def build_spec() -> PluginSpec:
    ...
    from campaign_planner.adapters.gcp.mcp_tool_catalog import McpToolCatalogAdapter
    from campaign_planner.agent.agent_card import agent_card_document
    ...
    return PluginSpec(
        ...
        license="Apache-2.0",
        repository="https://github.com/portable-genai/campaign-planner",
        ...
        servers={
            "campaign-planner": StdioServer(
                command="python",
                args=("-m", "campaign_planner.mcp"),
                cwd="${PLUGIN_ROOT}",
            )
        },
