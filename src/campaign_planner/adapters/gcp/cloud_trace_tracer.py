"""Cloud Trace tracer adapter (ObservabilityTracerPort) — GCP managed stack for D2.
...
counts) ever land on a span, never the prompt, the audience rows or the model response.
...
_INSTRUMENTATION_SCOPE = "campaign_planner.tracing"
_SERVICE = "campaign-planner"
