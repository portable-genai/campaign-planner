...
The ``live`` profile's drafter. It delegates every call to the shared
...
As under every profile, the model drafts the creative brief and narrates the plan summary over
the already-computed deterministic plan; it never decides the numbers.
"""
...
class LocalModelLLMAdapter:
    """Generate drafts and triage labels with the local open-weight model."""
