...
One of the reversibility (no-lock-in) migration placeholders: in the managed profile this port binds
...
let a spend-affecting plan bypass human review (rule R8), so porting on-premise *must* supply a real
hand-off to the sovereign review console. Filling this body in is the only change required.
"""
