...
One of the reversibility (no-lock-in) migration placeholders: in the managed profile this port
...
never let a spend-affecting plan bypass human review (rule R8), so porting on-premise *must* supply
