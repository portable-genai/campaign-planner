...
client-supplied ``actor`` is ignored entirely: the audit actor flows from here, closing
...
platform guardrail -> this per-backend check); this module is the per-backend ring.
"""
